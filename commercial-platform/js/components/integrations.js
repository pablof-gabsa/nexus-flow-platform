                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="glass-card p-6 rounded-xl border border-gray-100 dark:border-slate-700 relative overflow-hidden group">
                        <div class="absolute top-0 right-0 p-4">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" class="sr-only peer" 
                                    ${IntegrationsComponent.isEnabled('google_calendar') ? 'checked' : ''}
                                    onchange="IntegrationsComponent.toggle('google_calendar', this.checked)">
                                <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-brand-300 dark:peer-focus:ring-brand-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-brand-600"></div>
                            </label>
                        </div>

                        <div class="flex items-center gap-4 mb-4">
                            <div class="w-12 h-12 rounded-lg bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-blue-600 dark:text-blue-300 text-2xl font-bold">
                                <i class="fas fa-calendar-alt"></i>
                            </div>
                            <div>
                                <h3 class="font-bold dark:text-white">Google Calendar</h3>
                                <span class="text-xs text-blue-500 bg-blue-50 dark:bg-blue-900/30 px-2 py-0.5 rounded">Sincronización</span>
                            </div>
                        </div>
                        
                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                            Exporta tareas seleccionadas a tu calendario personal (.ics). Compatible con Google, Outlook y Apple.
                        </p>

                        <div class="text-xs text-gray-400">
                            Incluye: Fecha y Hora de vencimiento.
                        </div>
                    </div>
                </div>
            </div>
