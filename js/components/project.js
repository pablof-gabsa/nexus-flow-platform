                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                         ...
                         <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                            <div>
                                ...
                                <input type="date" name="real_start_date" id="task-real-start-date" class="input-primary w-full bg-gray-50 dark:bg-slate-700" title="Se fija al pasar a En Proceso" onfocus="UI.showToast('Advertencia: Está por modificar datos cargados automáticamente', 'warning')">
                            </div>
                            <div>
                                <label class="block text-sm font-medium dark:text-gray-300">Fin Real</label>
                                <input type="date" name="end_date" id="task-end-date" class="input-primary w-full bg-gray-50 dark:bg-slate-700" title="Se fija al pasar a Realizado" onfocus="UI.showToast('Advertencia: Está por modificar datos cargados automáticamente', 'warning')">
                            </div>
                         </div>
                         ...
                         <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                             ...
                             <div>
                                ...
                                <input type="number" name="hh_executed" id="task-hh-exe" step="1" class="input-primary w-full bg-gray-50 dark:bg-slate-700" title="Se calcula al finalizar" onfocus="UI.showToast('Advertencia: Está por modificar datos cargados automáticamente', 'warning')">
                             </div>
                         </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                             <div>
